...
def gs_query():
    ...
    gs_query = """
        ...
        WHERE "user.name" IN ('Orlando Sanchez', 'Devon Fish', 'Ryan Reeves', 'Jack McCoy', 'Mariana Flores', 'Seth Groth', 'Jordon Price', 'Brady Reinwald', 'Steven Gutierrez', 'Kevin Judd', 'Bryan Bodnar', 'Tanner Gottschalk', 'Justin Clayton', 'Joseph Schuh', 'Carson Beus', 'Austin Lowe', 'Caleb Phillips', 'Enzo Couillens', 'Brooks Haas', 'Rian Wright', 'Brendan Lee', 'Justic Brewton', 'Kyle Giffen', 'Michael Larrosa', 'Daniel Blankenship', 'Benjamin Toala', 'Houston Castillo', 'Mark Gransee', 'Austen Nine', 'Bret Nelson', 'Chris Bouchard', 'Michael Browne')
        GROUP BY ALL
